      ...
      <div className="absolute bottom-4 left-4 z-[1000] bg-white/95 dark:bg-slate-900/95 backdrop-blur-md p-3 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-xl text-xs space-y-2">
        ...
        <div className="flex flex-wrap gap-2">
          ...
          >
            ...
            {/* Static Legend (bottom-right) */}
      <div className="absolute bottom-4 right-4 z-[1000] bg-white/95 dark:bg-slate-900/95 backdrop-blur-md p-3 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-xl text-xs space-y-1.5">
        <p className="font-bold uppercase tracking-wider text-[10px] text-slate-500 dark:text-slate-400">
          Legend
        </p>
        <div className="flex items-center space-x-2">
          <span className="w-3 h-3 rounded-full bg-red-600" />
          <span className="text-slate-600 dark:text-slate-300">High Risk Zone</span>
        </div>
        <div className="flex items-center space-x-2">
          <span className="w-3 h-3 rounded-full bg-amber-500" />
          <span className="text-slate-600 dark:text-slate-300">Medium Risk Zone</span>
        </div>
        <div className="flex items-center space-x-2">
          <span className="w-3 h-3 rounded-full bg-emerald-500" />
          <span className="text-slate-600 dark:text-slate-300">Safe Zone</span>
        </div>
        <div className="flex items-center space-x-2">
          <span>📡</span>
          <span className="text-slate-600 dark:text-slate-300">IoT Sensor</span>
        </div>
        <div className="flex items-center space-x-2">
          <span>📷</span>
          <span className="text-slate-600 dark:text-slate-300">Citizen Report</span>
        </div>
        <div className="flex items-center space-x-2">
          <span>⌂</span>
          <span className="text-slate-600 dark:text-slate-300">Shelter</span>
        </div>
      </div>
