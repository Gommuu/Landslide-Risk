...
export default function GISMapPage() {
  ...
  useEffect(() => {
    apiClient.getHotspots().then(setHotspots);
    apiClient.getSensors().then(setSensors);
  ...
  return (
    <div className="p-8 bg-slate-50 min-h-screen">
      ...
      <div className="bg-white border rounded-3xl p-6 shadow-sm">
        ...
        {/* MAP */}
        <div className="h-[700px] rounded-2xl overflow-hidden border border-slate-200">
          <DynamicMap height="700px" hotspots={hotspots} sensors={sensors} incidents={incidents} />
        </div>
      </div>
